function pre_DSSNicola(trigger_list, subject_list, config)
    ...
    %last update by Mingyue Hu, 29/01/2023
...
%                 data_subject_BS = ft_preprocessing(cfg, data_subject);
                ...
                x_orig{trigger_ind} = cat(3,data_subject.trial{:});
            end
...
%                 t = data_subject.time{1};
                ...
                x1 = permute(x_orig{1},[2,1,3]); %RAND
                x2 = permute(x_orig{2},[2,1,3]); %REG
...
%                 dss_comp(:,:,subject_ind,2) = mean(av2,3);
                ...
                trigger_list(1),subject_list(subject_ind), NKEEP)),'DSSdata_subject1','DSS_timelock1');
                %save trigger 2
                save(fullfile('D:\Results',out_folder,'DSS_components','DSS_data',sprintf('Xdss-TRIG_%d-SUB_%d-COMP_%d_NBprocedure.mat',...
                trigger_list(2),subject_list(subject_ind), NKEEP)),'DSSdata_subject2','DSS_timelock2');
